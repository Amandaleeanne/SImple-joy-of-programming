...
The next step is to use the small demo I made from episode 3 to execute actual instructions. Afterwards, upgrade and refactor the demo to the final Episode 7's instructions.
