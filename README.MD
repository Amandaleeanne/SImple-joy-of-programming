...
The next step is to use the small demo I made from episode 3 to execute actual instructions. This will require me looking into makefiles and such as the codebase is starting to get unruly.

Afterwards, upgrade and refactor the demo to the final Episode 7's instructions.
...
## Stretch:
1. Rewrite the project idea for a visual GUI instead of using the CLI for the code using C-lay. Or, create a prettyPrint-esque CLI GUI.
2. Port to Python for Python practice

# Other information:
The instruction sets that I am following can be found and referenced below

Episode 3's instruction set (Demo)
![InstructionSet](./Documents/InstructionSetEP3.PNG)

Episode 7's instruction set (Goal)
